local cache = {} -- idk if this is works
...
function CRX.callback.await(event, playerId, ...)
...
---@diagnostic disable-next-line: duplicate-set-field
function CRX.callback.register(name, cb)
